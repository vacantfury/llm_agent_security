...
- **Cluster sync (family standard, settled 2026-08-02):** this repo already follows it — git clone/pull for the committed source + rsync for the gitignored `scripts/*.sbatch` ops layer + rsync-down for results. Canonical statement + rationale + footguns: devices repo `knowledge/cluster_sync_convention.md` (moved from the science organ 2026-08-05). Cite it; don't re-derive a per-repo scheme.
