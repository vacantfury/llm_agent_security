...
| Alias | Codename | Topic | Namespace | Stage |
|---|---|---|---|---|
| **E** | Smuggled Actions | Encoded indirect prompt injection defeats injection-specific defenses on LLM agents; success = action completion | `agent_injection` | founding (S4 lit/scoop done) |
