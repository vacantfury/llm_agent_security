"""
Formal Logic processor - Mathematical encoding using first-order logic,
propositional calculus, and proof theory.

Prompts, few-shot demonstrations, and target prefix are loaded from:
  conf/text_encoding/formal_logic.yaml
"""
...
class FormalLogicLLMEncoder(BaseEncoder):
    ...
    All prompts are loaded from conf/text_encoding/formal_logic.yaml.
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        config = load_prompt_template("formal_logic.yaml")
        ...
        logger.info(f"Initialized FormalLogicLLMEncoder with model: {model}")
